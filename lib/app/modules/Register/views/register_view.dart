        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Obx(
                () => controller.formErrors['phone'] != null
                    ? Padding(
              ...
              Obx(
                () => controller.formErrors['city'] != null
                    ? Padding(
                        padding: const EdgeInsets.only(top: 6, left: 4),
                        child: Text(
              ...
              // Champ Referral Code
              _buildLabel('referral_code_optional'.tr),
              _buildTextField(
                    ...
                    child: Padding(
                      ...
                      child: RichText(
                        text: TextSpan(
                          ...
                          children: [
                            TextSpan(text: 'en_continuant_jaccepte'.tr),
                            TextSpan(
                              text: 'termes_dutilisation'.tr,
                              style: TextStyle(
                                fontWeight: FontWeight.w600,
                                decoration: TextDecoration.underline,
                              ),
                            ),
                            TextSpan(text: 'et_la'.tr),
                            TextSpan(
                              text: 'politique_de_confidentialite'.tr,
                              style: TextStyle(
                                fontWeight: FontWeight.w600,
                                decoration: TextDecoration.underline,
                              ),
  ...
  Widget _buildTextField({
    ...
    return Column(
      ...
      children: [
        ...
        if (errorKey != null)
          Obx(
            () => this.controller.formErrors[errorKey] != null
                ? Padding(
                    padding: const EdgeInsets.only(top: 6, left: 4),
                    child: Text(
